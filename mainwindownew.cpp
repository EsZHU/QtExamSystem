...
void MainWindowNew::initMenu()
{
    ...
    QMenu *guanli = menuBar()->addMenu(tr("&管理菜单"));
    ...
    QAction *newActHistoryManage = new QAction(tr("&历史记录管理"), this);
    ...
    guanli->addAction(newActHistoryManage);

    QMenu *help = menuBar()->addMenu(tr("&帮助菜单"));

    QAction *helpDialogManage = new QAction(tr("&帮助文档"), this);
    connect(helpDialogManage, &QAction::triggered, [=](){
        HelpDialog* helpDialog = new HelpDialog();
        helpDialog->show();
        helpDialog->setWindowModality(Qt::ApplicationModal);
    });
    help->addAction(helpDialogManage);

    QAction *aboutDialogManage = new QAction(tr("&关于系统"), this);
    connect(aboutDialogManage, &QAction::triggered, [=](){
        AboutDialog* aboutDialog = new AboutDialog();
        aboutDialog->show();
        aboutDialog->setWindowModality(Qt::ApplicationModal);
    });
    help->addAction(aboutDialogManage);
